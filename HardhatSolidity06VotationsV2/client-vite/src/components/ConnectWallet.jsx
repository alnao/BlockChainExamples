    ...
    <div className="connect-wallet-container">
      <div className="connect-card">
        ...
        <p className="description">
          ...
          Puoi registrarti come candidato durante la fase di registrazione o votare
          durante la fase di votazione.
        </p>
        ...
        <div className="metamask-info">
          ...
          />
          <p>
            Per utilizzare l'applicazione è necessario connettersi con un wallet
            Ethereum (MetaMask, Rabby, ecc.).
          </p>
        </div>
